...
class TCPDF {
	...
	public function Header() {
		...
		//if($_SESSION['sessionCentral']==1 or $_SERVER['SERVER_NAME']=='www.driverlog.com.br'){
		//	$logo = 'driverlog_logo'; 
		//}
		//elseif($_SESSION['sessionCentral']==2){
			$logo = 'logo_cielo2'; 
		//}

		$this->Image('../includes/tcpdf/images/'.$logo.'.png','' , '', 34, 34, 'PNG', '', '', false, 60, 'R', false, false, 0, $fitbox, false, true);
	...
	public function Footer() {
		$this->Cell( 0, 5, date('d/m/Y H:i'), 0, 0, '' );
		$cur_y = $this->y;
		$this->SetTextColor(0, 0, 0);
		...
		if ($this->getRTL()) {
			$this->SetX($this->original_rMargin);
			$this->Cell(0, 2, $pagenumtxt, 'T', 0, 'L');
		} else {
			$this->SetX($this->original_lMargin);
			$this->Cell(0, 2, $pagenumtxt, 'T', 0, 'R');
		}
	}
